...
![CleanShot 2026-05-16 at 17.01.56@2x](./assets/CleanShot 2026-05-16 at 17.01.56@2x.png)
...
<img src="./assets/CleanShot 2026-05-16 at 17.02.32@2x.png" alt="CleanShot 2026-05-16 at 17.02.32@2x" style="zoom:50%;" />

<img src="./assets/CleanShot 2026-05-16 at 17.04.04@2x.png" alt="CleanShot 2026-05-16 at 17.04.04@2x" style="zoom:50%;" />

<img src="./assets/CleanShot 2026-05-16 at 17.04.36@2x.png" alt="CleanShot 2026-05-16 at 17.04.36@2x" style="zoom:50%;" />
...
## Contact
[my REDNOTE](https://www.xiaohongshu.com/user/profile/61c83d00000000001000bd3e)



# 可视化UI元素编辑器
<span id="Simplified-Chinese">一个帮助你可视化选择并修改任意UI元素的插件</span>

# 如何使用

![CleanShot 2026-05-16 at 17.20.46@2x](./assets/CleanShot 2026-05-16 at 17.20.46@2x.png)
...
## 如何安装
1. 官方插件市场搜索**Visual Ui Editor**(推荐)
2. 使用BRAT插件安装, 安装**BRAT**插件后输入本仓库路径: echorgi/obsidian-visual-ui-editor

## 🍠
[我的小红书主页](https://www.xiaohongshu.com/user/profile/61c83d00000000001000bd3e)




# 可視化 UI 元素編輯器
<span id="Traditional-Chinese"> 一個幫助你可視化選擇並修改任意 UI 元素的插件 </span>

# 如何使用

![CleanShot 2026-05-16 at 17.17.12@2x](./assets/CleanShot 2026-05-16 at 17.17.12@2x.png)

點擊左側功能欄的瞄準圖標，會進入選擇模式，此時滑鼠移到任意元素即可選中同類元素，左鍵點擊後會打開編輯欄，如圖

<img src="./assets/CleanShot 2026-05-16 at 17.18.41@2x.png" alt="CleanShot 2026-05-16 at 17.18.41@2x" style="zoom:50%;" />

<img src="./assets/CleanShot 2026-05-16 at 17.19.32@2x.png" alt="CleanShot 2026-05-16 at 17.19.32@2x" style="zoom:50%;" />

<img src="./assets/CleanShot 2026-05-16 at 17.19.59@2x.png" alt="CleanShot 2026-05-16 at 17.19.59@2x" style="zoom:50%;" />
